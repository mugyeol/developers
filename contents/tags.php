...
$SELF_URL = "../../developers/developers.php?menu=tags&which=".$get_tag; // 기본 url
...
$sql_numrows = "SELECT * FROM article RIGHT JOIN hashtag ON article.article_id = hashtag.tagged_article_id where tagstring = '$get_tag'";



    $taglink = "&which=".$_GET['which'];
...
$sql = "SELECT * FROM article LEFT JOIN user_info ON article.user_code = user_info.id RIGHT JOIN hashtag ON article.article_id = hashtag.tagged_article_id where tagstring = '$get_tag' $orderby LIMIT $s_point,$list";
            ...
            <div class="right_side">
                ...
                <div class="wrapper_title_writebtn">
                    ...
                    <div class="my_headtitle">
                        <h1 style="display: inline;">Tagged</h1>
                        <button class="btn btn-info btn-lg" style="margin-left: 20px"><?=$get_tag?></button>
                    </div>
                    ...
                    <div class="mysortbtns btn-group " role="group" aria-label="First group">
                        <button type="button" class="btn btn-default "><a class="sortbtnslink" style="text-decoration: none; color: black;" href="../../developers/developers.php?menu=tags<?=$taglink?>">최신순</a> </button>
                        <button type="button" class="btn btn-info "><a class="sortbtnslink" style="text-decoration: none; color: white;"  href="../../developers/developers.php?menu=tags<?=$taglink?>&desc=view">조회순</a> </button>
                        <button type="button" class="btn btn-primary">
                            <a class="sortbtnslink" style="text-decoration: none; color: white;" href="../../developers/developers.php?menu=tags<?=$taglink?>&desc=liked">추천순</a>
                        </button>
                        <button type="button" class="btn btn-danger"><a class="sortbtnslink" style="text-decoration: none; color: white;" href="../../developers/developers.php?menu=tags<?=$taglink?>&desc=reply">댓글순</a> </button>
                    </div>
